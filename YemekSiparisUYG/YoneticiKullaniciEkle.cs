    ...
    public partial class YoneticiKullaniciEkle : Form
    {
        ...
        private void EkleBTN_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ykd.DataYenile();
                LogTut.LogKaydet("Yönetici",$" ID li yönetici kullanıcı ekleme işlemi yaptı,bilgiler:" +
                    $" yetki:{yetki}kullanıcı adı:{kullaniciAdi}:Şifre:{sifre} ");
            }
        ...
        private void Temizle() 
        {
            ...
            SifreTXT.Text = "";
            LogTut.LogKaydet("Yönetici"," ID li yönetici kullanıcı ekle sayfasında textleri temizledi");
        }
