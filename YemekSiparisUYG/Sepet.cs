...
namespace YemekSiparisUYG
{
    public partial class Sepet : Form
    {
        ...
        {//LİSTEYİ TEMİZLE
            ...
            LogTut.LogKaydet("Personel", "ID li personel SEPET sayfasın da sepeti temizledi: ");
            }
		...
		{//sipariş i tamamla
            ...
            LogTut.LogKaydet("Personel", "ID li personel Sepet sayfasında sepeti tamamladı");
            }
			catch (Exception ex) 
            {
                MessageBox.Show("hata:" + ex);
                LogTut.LogKaydet("Personel", "ID li personel Sepet sayfasında sepeti tamamlayamadı hata aldı: "+ex );
            }
